...
export const accountEmbeddings = sqliteTable(
  "account_embeddings",
  {
    id: text("id").primaryKey(),
...
export const dailyBriefings = sqliteTable(
  ...
  (table) => ({
    ownerDateIdx: uniqueIndex("daily_briefings_owner_date_idx").on(
      table.ownerEmail,
      table.briefingDate,
    ),
 ...
 */
export const dailyBriefingVariants = sqliteTable(
  ...
  (table) => ({
    ownerDateLocaleIdx: uniqueIndex(
      "daily_briefing_variants_owner_date_locale_idx",
    ).on(table.ownerEmail, table.briefingDate, table.locale),
...
export const accountRelationships = sqliteTable(
...
export const accountGraphLayouts = sqliteTable(
...
export const externalSignals = sqliteTable(
  "external_signals",
  {
    id: text("id").primaryKey(),
    discoveryId: text("discovery_id")
...
export const actionFeedback = sqliteTable(
  "action_feedback",
  {
    id: text("id").primaryKey(),
...
export const guidedDiscoverySessions = sqliteTable(
...
export const guidedDiscoveryAnswers = sqliteTable(
  "guided_discovery_answers",
  {
    ...
    supersedesId: text("supersedes_id").references(
      (): AnySQLiteColumn => guidedDiscoveryAnswers.id,
      { onDelete: "set null" },
    ),
 ...
 */
export const accountChangeSets = sqliteTable(
  "account_change_sets",
  {
    id: text("id").primaryKey(),
    discoveryId: text("discovery_id")
...
export const commercialAgentRuns = sqliteTable(
...
export const crmHandoffs = sqliteTable(
  "crm_handoffs",
  {
    id: text("id").primaryKey(),
    discoveryId: text("discovery_id")
...
export const accountImpactMetrics = sqliteTable(
